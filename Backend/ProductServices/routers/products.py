...
try:
    ...
    POS_PROJECT_ROOT_DIR = POS_ROUTER_FILE_DIR.parent 
except NameError: 
    POS_PROJECT_ROOT_DIR = Path(".").resolve() 
...
# --- Auth Validation Functions for POS --- 
...
def _construct_full_url_for_pos_served_image(pos_db_image_path_segment: Optional[str]) -> Optional[str]:
    ...
    return pos_db_image_path_segment 
    ...
    try:
        ...
        async with conn.cursor() as cursor:
            ...
            """, product_payload.ProductName, pos_product_type_id, product_payload.ProductCategory,
                 ...
                 pos_db_image_path_segment_to_store) 
