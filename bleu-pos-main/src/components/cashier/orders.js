  ...
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      try {
        ...
        const newStoreOrders = transformedOrders.filter(o => o.orderType === 'Dine in' || o.orderType === 'Take out');
        const newOnlineOrders = transformedOrders.filter(o => o.orderType !== 'Dine in' && o.orderType !== 'Take out');
